 ...
 <div class="application">
        ...
        <div class="delCon">
            ...
            <div class="iptBox">
                ...
                <p id="ageError" class="error" style="display:none">请选择年龄段</p>
                @if($errors->has('age'))
            ...
            <div class="iptBox">
                ...
                <p style="display:none;" id="amountError" class="error">借款金额不能为空</p>
                @if($errors->has('money'))
            ...
            <div class="iptBox">
                <span>手机号码</span>
                <input id="mobile" name="mobile" value="{{old('mobile')}}" placeholder="请输入手机号码" maxlength="11" type="text">
                <p id="mobileError" class="error" style="display:none">请输入真实的手机号码</p>
            ...
            <div class="iptBox">
                ...
                <img src="{{$bu->inline()}}" name="imgc" id="imgc" alt="换一张" class="get-code" height="36" width="80">
                <p id="imgcodeError" class="error" style="display:none">图形验证码错误，请重新输入</p>
            </div>
            <div class="iptBox">
                <span class="message">短信验证码</span>
                <input class="short" name="verify" id="fucode" placeholder="请输入短信验证码" type="text">
                <i><a href="javascript:;" class="get-code" id="dtmbtn" name="dtmbtn">获取验证码</a></i>
                 <p id="yzm" class="error" style="display:none">请输入真实的手机号码验证码错误,请重新输入</p>
				 <p id="yzm1" class="error" style="display:none">短信验证码错误</p>
            </div>
