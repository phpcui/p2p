                    ...
                    <div class="pro_bor">
                        <ul class="clearfix pro_list_box">
                            ...
                            <li class="w3">
                                ...
                                <p class="fc_6 airal fs_18">{{$p->money-$p->revice}}</p>
                            </li>
                            <li class="w4">
                                <span class="b_jingdu b_jd{{sprintf('%.2f',$p->revice/$p->money)*100}}">{{sprintf('%.2f',$p->revice/$p->money)*100}}%</span>
                            </li>
                            <li class="w5">
                                    <a class="btn btnSize_1 btn_orange" href="{{url('/',['tb',$p->pid])}}">立即投标</a>
                            </li>
                        </ul>
                    </div>
                    <!--1 e -->
