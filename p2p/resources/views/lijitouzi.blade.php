                	...
                	<div class="td_all2">
                        ...
                        <table width="100%" class="fc_6">
                            ...
                            <tr>
                                ...
                                <td style="padding-right:0;width:220px;"><input style="width:140px;" class="fc_orange airal fs_18" name='money' value="{{$pro->money-$pro->revice}}">元</td>
                            </tr>                          
                        </tbody>
                        </table>
